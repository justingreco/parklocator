	...
	var requestHandle = esri.request({
		...
		load:function(response, io){
			$.each(response, function(index, value){
				if (value.park == title){
					esri.request({
						url:'http://maps.raleighnc.gov/arcgis/rest/services/Parks/ParkLocator/MapServer/exts/ParkLocatorSOE/ProgramSearch',
...
{
    $.get("http://maps.raleighnc.gov/arcgis/rest/services/Parks/ParkLocator/MapServer/exts/ParkLocatorSOE/ProgramSearch",
